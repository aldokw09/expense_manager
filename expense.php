      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="clearfix">
            ...
            <div class="float-right btn border border-danger text-danger px-4" id="balance" style="cursor: default; margin-top: -30px;">
                Total Expense : <br> <span class="h5 font-weight-bold">Rp {{ expenses }},-</span>
            </div>
          </div>
          ...
          <div class="row" id="manage">
            <div class="col-xl-4 col-sm-6 mb-3" v-for='manage in displayedPosts'>
              <div class="card text-white o-hidden h-100" style="background-color: rgb(241, 100, 100)">
                ...
                <div class="card-body">
                  ...
                  <div class="font-weight-bold">Rp {{ manage.ammount_ex }},-</div>
                </div>
              </div>
            </div>
      ...
      <div class="modal-content" id="insert">
        ...
        <div class="modal-body">
          <div class="form-group col-md-12">
              ...
              <input type="text" pattern="\d*" class="form-control" v-on:keyup="ubahrupiah()" id="ammount" v-model="ammount" v-on:input="checkAmmount" required>
              ...
              <div class="categorys">
                <select class="form-control" v-model="category" v-on:input="checkCategory" required>
                	...
                	<option v-for="categorys in list_category" v-if="categorys.type_category == '2'" :value="categorys.id_category">{{categorys.name_category}}</option>
                </select>
              </div>
              <label for="date">Date :
  ...
  var manage = new Vue({
    ...
    methods:{
      ambil: function(){
        ...
        axios.get('transactionShow2.php?id_user=<?php echo $_SESSION['user123'] ?>')
      ...
      editData: function(value){
        ...
        .then(function (result) {
          ...
          manage.ammount2 = manage.list_manage2[0].ammount_ex;
          $('#dataName').html("("+manage.list_manage2[0].names+")");
        });
      },
      edits: function(){
        axios.get('transactionEditData.php?id_user=<?php echo $_SESSION['user123'] ?>&type=2&id_manage='+manage.value+'&names='+manage.names2+'&ammount='+manage.ammount2)
        .then(function (result) {
    ...
    methods:{
      ...
      tambah: function(){
        ...
        if(this.names != "" && this.names != null && this.ammount != "" && this.ammount!= null && this.ammount != "0" &&
          ...
          axios.get("transactionAdd.php?id_user=<?php echo $_SESSION['user123'] ?>&type=2&names=" +this.names+ "&ammount=" +this.ammount+ "&category=" +this.category+ "&date=" +this.date)
          .then(function (result) {
